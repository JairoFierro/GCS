...
# ============================================
# CONFIGURACIÓN (debe coincidir con C++)
# ============================================

# Key: Exactamente como en tu C++ (16 bytes)
ASCON_KEY = bytes([
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
    0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F
])

# Nonce base (será construido dinámicamente)
    ...
    def decrypt_message(self, msg_bytes, sysid, compid, seq):
        ...
        try:
            ...
            plaintext = ascon_decrypt(
                key=self.key,
                nonce=nonce,
                associateddata=b'',  # Sin AD, como en tu C++
                ciphertext=msg_bytes  # Incluye el tag de 16 bytes al final
            )
